...
class StringTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context("like for PredicateSpecification checks if property matches pattern") {
        ...
        context("notLike for PredicateSpecification checks if property does not match pattern") {
            expect("with prefix pattern") {
        ...
        context("like for PredicateSpecification checks if nested property matches pattern") {
        ...
        context("notLike for PredicateSpecification checks if nested property does not match pattern") {
            expect("with nested types") {
                val spec =
                    (Organisation::organisationInfo / OrganisationInfo::addressInfo / AddressInfo::street)
                        .notLike("Main%")
