...
class InclusionTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context("notIn and notContainedIn for Specification checks if property is not in the given value") {
            withExpects(
                nameFn = { "${it.second} with single int" },
        ...
        context("notIn and notContainedIn for Specification checks if nested property is not in the given value") {
            withExpects(
                nameFn = { "${it.second} with nested types" },
                (Organisation::organisationInfo / OrganisationInfo::addressInfo / AddressInfo::street)
