...
/**
 * Creates a [PredicateSpecification] that performs a fetch and applies a list of [Predicate]s by ANDing them to the fetch-joined entity.
 *
 * @param T the type of the root entity.
 * @param R the type of the fetch-joined entity.
