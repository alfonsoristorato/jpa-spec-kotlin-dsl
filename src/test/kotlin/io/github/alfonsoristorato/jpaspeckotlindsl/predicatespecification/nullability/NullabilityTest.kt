...
class NullabilityTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context("isNull for PredicateSpecification checks for property to be null") {
        ...
        context("isNotNull for PredicateSpecification checks for property to not be null") {
            expect("with non-nullable property") {
                val result =
                    personaRepository.findAll(
        ...
        context("isNull for PredicateSpecification checks for nested property to be null") {
        ...
        context("isNotNull for PredicateSpecification checks for nested property to not be null") {
            expect("with nested nullable types") {
                val spec =
                    (Organisation::organisationInfo / OrganisationInfo::contactInfo / ContactInfo::email)
                        .isNotNull()
