...
class BoolTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context("isTrue for PredicateSpecification checks for Boolean true") {
        ...
        context("isFalse for PredicateSpecification checks for Boolean false") {
            expect("with non-nullable Boolean property") {
                val result =
                    personaRepository.findAll(
        ...
        context("isTrue for PredicateSpecification checks for nested Boolean true") {
        ...
        context("isFalse for PredicateSpecification checks for nested Boolean false") {
            expect("with nested types") {
                val spec =
                    (Organisation::organisationInfo / OrganisationInfo::addressInfo / AddressInfo::isActive)
                        .isFalse()
