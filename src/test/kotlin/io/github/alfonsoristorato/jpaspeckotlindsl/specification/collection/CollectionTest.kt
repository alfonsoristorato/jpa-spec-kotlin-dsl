...
class CollectionTest(
    ...
    private val postRepository: PostRepository,
        ...
        context("isEmpty for Specification tests whether a collection is empty") {
        ...
        context("isMember for Specification tests whether an element is a member of a collection") {
