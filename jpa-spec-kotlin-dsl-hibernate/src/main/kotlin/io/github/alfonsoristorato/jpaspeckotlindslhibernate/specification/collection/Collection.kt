...
/**
 * Creates a [Specification] that tests whether a native collection column contains all elements of the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param T the type of the entity.
 ...
 * @return A [Specification] that tests whether all elements of the sub-collection are contained in the native collection column.
 */
@ExperimentalHibernateApi
fun <T : Any, E> KProperty1<T, Collection<E>>.collectionIncludes(subCollection: Collection<E>): Specification<T> =
    Specification { root, _, criteriaBuilder ->
        collectionIncludes(root, criteriaBuilder, subCollection)
    }

/**
 * Creates a [Specification] that tests whether a native collection column does not contain all elements of the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param T the type of the entity.
 ...
 * @return A [Specification] that tests whether not all elements of the sub-collection are contained in the native collection column.
 */
@ExperimentalHibernateApi
fun <T : Any, E> KProperty1<T, Collection<E>>.collectionNotIncludes(subCollection: Collection<E>): Specification<T> =
    Specification { root, _, criteriaBuilder ->
        collectionNotIncludes(root, criteriaBuilder, subCollection)
    }

/**
 * Creates a [Specification] that tests whether a nested native collection column contains all elements of the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param ROOT the root entity type.
 ...
 * @param PROP the type of the [Collection] property.
 * @param subCollection the sub-collection whose elements must all be present in the column.
 * @return A [Specification] that tests whether all elements of the sub-collection are contained in the nested native collection column.
 */
@ExperimentalHibernateApi
fun <ROOT : Any, E, PROP : Collection<E>> NestedProperty<ROOT, PROP>.collectionIncludes(subCollection: Collection<E>): Specification<ROOT> =
    Specification { root, _, criteriaBuilder ->
        collectionIncludes(root, criteriaBuilder, subCollection)
    }

/**
 * Creates a [Specification] that tests whether a nested native collection column does not contain all elements of the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param ROOT the root entity type.
...
/**
 * Creates a [Specification] that tests whether a native collection column shares at least one element with the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param T the type of the entity.
 ...
 * @return A [Specification] that tests whether the native collection column intersects with the given sub-collection.
 */
@ExperimentalHibernateApi
fun <T : Any, E> KProperty1<T, Collection<E>>.collectionIntersects(subCollection: Collection<E>): Specification<T> =
    Specification { root, _, criteriaBuilder ->
        collectionIntersects(root, criteriaBuilder, subCollection)
    }

/**
 * Creates a [Specification] that tests whether a native collection column does not share any element with the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param T the type of the entity.
 * @param E the type of the element in the collection.
 * @param subCollection the sub-collection to check for overlap.
 * @return A [Specification] that tests whether the native collection column does not intersect with the given sub-collection.
 */
@ExperimentalHibernateApi
fun <T : Any, E> KProperty1<T, Collection<E>>.collectionNotIntersects(subCollection: Collection<E>): Specification<T> =
    Specification { root, _, criteriaBuilder ->
        collectionNotIntersects(root, criteriaBuilder, subCollection)
    }

/**
 * Creates a [Specification] that tests whether a nested native collection column shares at least one element with the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param ROOT the root entity type.
 ...
 * @param PROP the type of the [Collection] property.
 * @param subCollection the sub-collection to check for overlap.
 * @return A [Specification] that tests whether the nested native collection column intersects with the given sub-collection.
 */
@ExperimentalHibernateApi
...
/**
 * Creates a [Specification] that tests whether a nested native collection column does not share any element with the given sub-collection.
 * Use this for properties mapped with [@JdbcTypeCode(SqlTypes.ARRAY)][org.hibernate.annotations.JdbcTypeCode]
 * and typed as [Collection].
 *
 * @param ROOT the root entity type.
 ...
 * @param PROP the type of the [Collection] property.
 * @param subCollection the sub-collection to check for overlap.
 * @return A [Specification] that tests whether the nested native collection column does not intersect with the given sub-collection.
 */
@ExperimentalHibernateApi
