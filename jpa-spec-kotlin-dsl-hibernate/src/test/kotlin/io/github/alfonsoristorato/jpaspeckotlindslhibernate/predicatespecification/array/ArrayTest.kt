...
class ArrayTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context(
            "arrayIntersects for PredicateSpecification tests whether a native array column shares at least one element with a sub-array",
        ) {
        ...
        context("arrayNotIntersects for PredicateSpecification tests whether a native array column shares no element with a sub-array") {
