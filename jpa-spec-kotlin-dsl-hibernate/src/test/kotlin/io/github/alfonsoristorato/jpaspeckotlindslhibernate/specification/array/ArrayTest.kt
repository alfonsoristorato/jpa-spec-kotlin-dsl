...
class ArrayTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context("arrayIncludes for Specification tests whether a native array column contains all elements of a sub-array") {
        ...
        context("arrayNotIncludes for Specification tests whether a native array column does not contain all elements of a sub-array") {
