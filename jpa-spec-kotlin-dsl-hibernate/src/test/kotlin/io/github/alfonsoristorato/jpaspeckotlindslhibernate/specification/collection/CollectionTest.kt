...
class CollectionTest(
    ...
    private val organisationRepository: OrganisationRepository,
        ...
        context(
            "collectionIntersects for Specification tests whether a native collection column shares at least one element with a sub-collection",
        ) {
        ...
        context(
            "collectionNotIntersects for Specification tests whether a native collection column shares no element with a sub-collection",
        ) {
